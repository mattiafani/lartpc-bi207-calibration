...
def storeInfo(raw_data_folder_name, i_event, i_raw_file_name, i_raw_file_counter, i_binary_event, i_converted_file_counter, i_converted_event):
    ...
    print(f"\nSelected Event: {i_event}, {i_raw_file_name}, ({i_raw_file_counter},{
          i_binary_event}) ({i_converted_file_counter},{i_converted_event})\n")

    filename = f"../DATA/{raw_data_folder_name}/{
        raw_data_folder_name}_selectedEvents.txt"
    ...
    with open(filename, "a") as f:
        ...
        f.write(f"{i_event},{i_raw_file_name},{i_raw_file_counter},{
                i_binary_event},{i_converted_file_counter},{i_converted_event}\n")
